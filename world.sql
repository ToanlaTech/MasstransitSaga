...
CREATE TABLE `order` (
    `Id` INT AUTO_INCREMENT PRIMARY KEY,        -- ID của đơn hàng (tự tăng)
    `CountryCode` CHAR(3) NOT NULL,             -- Mã quốc gia (liên kết với bảng Countries)
    `TotalAmount` DECIMAL(15, 2) NOT NULL,      -- Tổng số tiền của đơn hàng
    `OrderDate` DATETIME NOT NULL,              -- Ngày đặt hàng
    FOREIGN KEY (`CountryCode`) REFERENCES `country`(`Code`) -- Ràng buộc khóa ngoại
);

INSERT INTO `order` (`CountryCode`, `TotalAmount`, `OrderDate`) VALUES
('USA', 10000.50, '2023-12-01 10:00:00'),
('USA', 15000.00, '2023-12-02 14:30:00'),
('CAN', 7000.25, '2023-12-03 09:45:00'),
('CAN', 8500.75, '2023-12-04 11:15:00'),
('FRA', 12000.00, '2023-12-05 16:00:00'),
('FRA', 9500.50, '2023-12-06 13:20:00'),
('DEU', 18000.00, '2023-12-07 08:10:00'),
('DEU', 12500.25, '2023-12-08 17:40:00'),
('JPN', 14000.75, '2023-12-09 19:00:00'),
('JPN', 15500.00, '2023-12-10 12:30:00'),
('IND', 3000.00, '2023-12-11 10:15:00'),
('IND', 5000.50, '2023-12-12 14:45:00');
